    ...
    public partial class initData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false,defaultValueSql: "NEXT VALUE FOR shared.UserIdSequence"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Specilazations", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_testLabInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "int", nullable: false, defaultValueSql: "NEXT VALUE FOR shared.UserIdSequence"),
                    ClincLocation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Doctors_Specilazations_DoctorSpecializationId",
                        column: x => x.DoctorSpecializationId,
                        principalTable: "Specilazations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
